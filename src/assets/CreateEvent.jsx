...
const CreateEvent = () => {
  ...
  const { register, handleSubmit, reset, getValues, setValue, formState: { isSubmitting, errors } } = useForm();
  ...
  // ✅ When user toggles Free, force price = 0
  ...
  const handleGenerateDiscription = async () => {
    setaiError ("");
    ...
    try{
      ...
      setValue("description",data.description,{shouldValidate: true});
       ...
       if (err.response?.status === 429) {
        ...
        setaiError("API credits exhausted. Contact support.");
      } else {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await API.post("/events", formData, { withCredentials: true });
      reset();
      setImage(null);
      setPreview(null);
  ...
  const inputCls = (err) =>
    `w-full px-4 py-3 rounded-xl border text-sm outline-none transition-all
     ...
     ${err ? "border-red-400 bg-red-50" : "border-gray-200 hover:border-purple-300"}`;
      ...
      <div className="min-h-screen bg-[#faf8ff] pb-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12">
          ...
          <div className="mb-6 sm:mb-8">
            <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Create Event</h1>
            <p className="text-sm text-gray-500 mt-1">Fill in the details to publish your event on Eventify</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-purple-100 overflow-hidden">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-5 sm:p-8 space-y-5 sm:space-y-6">
              ...
              <div>
                ...
                <input
                  placeholder="e.g. MMRDA Grounds, BKC, Mumbai"
              ...
              <div>
                ...
                {!isFree && (
                  <>
                    ...
                    <p className="text-xs text-gray-400 mt-1.5">Enter the price per ticket in Indian Rupees</p>
                  </>
                )}
              </div>
              ...
              <div>
                ...
                onClick={handleGenerateDiscription}           
                >{generating ? (
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="sm:w-28 border border-gray-200 hover:border-purple-300 text-gray-600
                             font-semibold py-3 rounded-xl text-sm hover:text-purple-600 transition-all"
                >
                  Cancel
                </button>
              </div>
